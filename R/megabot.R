...
#' 
#' @param fit.y The fitting function used for the model of \var{Y} on
#' \var{Z}.  Options are \samp{ordinal}, \samp{lm}, \samp{lm.emp},
#' \samp{poisson}, \samp{nb}, and \samp{orm}.
#'
...
#' 
#' @param link.y The link family to be used for the ordinal model of 
#' \var{Y} on \var{Z}.  Defaults to \samp{logit}. Other options are
#' \samp{probit}, \samp{cloglog}, and \samp{cauchit}. Used only when
#' \samp{fit.y} is either \samp{ordinal} or \samp{orm}.
#'
